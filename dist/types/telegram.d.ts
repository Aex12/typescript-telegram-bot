...
export declare type InputFile = Buffer | File | string;
...
export declare type Response<T> = ValidResponse<T> | ErrorResponse;
export declare type RequestParameters = GetUpdatesParameters | SetWebhookParameters | DeleteWebhookParameters | ResponseParameters | CopyMessageParameters | ForwardMessageParameters | SendMessageParameters | SendPhotoParameters | SendAudioParameters | SendDocumentParameters | SendVideoParameters | SendAnimationParameters | SendVoiceParameters | SendVideoNoteParameters | SendMediaGroupParameters | SendLocationParameters | EditMessageLiveLocationParameters | StopMessageLiveLocationParameters | SendVenueParameters | SendContactParameters | SendPollParameters | SendDiceParameters | SendChatActionParameters | GetUserProfilePhotosParameters | GetFileParameters | KickChatMemberParameters | UnbanChatMemberParameters | RestrictChatMemberParameters | PromoteChatMemberParameters | SetChatAdministratorCustomTitleParameters | SetChatPermissionsParameters | ExportChatInviteLinkParameters | SetChatPhotoParameters | DeleteChatPhotoParameters | SetChatTitleParameters | SetChatDescriptionParameters | PinChatMessageParameters | UnpinChatMessageParameters | UnpinAllChatMessagesParameters | LeaveChatParameters | GetChatParameters | GetChatAdministratorsParameters | GetChatMembersCountParameters | GetChatMemberParameters | SetChatStickerSetParameters | DeleteChatStickerSetParameters | AnswerCallbackQueryParameters | SetMyCommandsParameters | EditMessageTextParameters | EditMessageCaptionParameters | EditMessageMediaParameters | EditMessageReplyMarkupParameters | StopPollParameters | DeleteMessageParameters | SendStickerParameters | GetStickerSetParameters | UploadStickerFileParameters | CreateNewStickerSetParameters | AddStickerToSetParameters | SetStickerPositionInSetParameters | DeleteStickerFromSetParameters | SetStickerSetThumbParameters | AnswerInlineQueryParameters | SendInvoiceParameters | AnswerShippingQueryParameters | AnswerPreCheckoutQueryParameters | SetPassportDataErrorsParameters | SendGameParameters | SetGameScoreParameters | GetGameHighScoresParameters;
...
export declare type CallbackGame = unknown;
